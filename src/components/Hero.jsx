      ...
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left px-10 lg:px-20">
          ...
          <p className="text-gray-600 text-lg md:text-xl mb-6">
            I love whimsy, bringing life to ideas and being a silly goose.
          </p>
        ...
        {/* Image Section */}
        <div className="w-full max-w-500 lg:max-w-500 md:w-1/2 flex justify-center mb-6 md:mb-0 p-8 lg:px-25">
