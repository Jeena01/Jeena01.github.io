...
export default function Grad() {
  return (
    <section className="w-full py-20 bg-gray-100 flex items-center justify-center">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 py-12">
            1° (Degree) Hotter 🎓
          </h2>
  ...
  <br/>I love channeling my creativity into software projects and opportunities that make a positive impact in people's lives.  
